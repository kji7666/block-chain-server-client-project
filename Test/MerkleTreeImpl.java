...
public class MerkleTreeImpl implements MerkleTree{
    ...
    private static final Logger LOGGER = Logger.getLogger(MerkleTreeImpl.class.getName());
    
    /**
     * Constructs a MerkleTreeImpl with the specified data blocks.
     *
     * @param dataBlocks the list of data blocks (strings) to build the tree.
     * @throws IllegalArgumentException if dataBlocks is null or empty.
     */
    public MerkleTreeImpl(List<String> dataBlocks){
