...
public class BlockImpl implements Block {
    ...
    private static boolean NONCE_TEST = false;
    private static boolean TIMEOUT_TEST = true;
    private static Logger logger = Logger.getLogger(BlockImpl.class.getName());
    private static final long TIMEOUT_THRESHOLD_FOR_MAKING_ONE_BLOCK = 600000; //10 minutes
    ...
    public BlockImpl(){
        ...
        this.height = 0;
        this.merkleRoot = new MerkleTreeImpl(Arrays.asList(this.transactions));
    ...
    public BlockImpl(BlockImpl previousBlock, String[] transactions){ 
        ...
        this.merkleRoot = new MerkleTreeImpl(Arrays.asList(transactions));
        this.merkleRootHash = this.merkleRoot.getMerkleRoot();
    ...
    private void setCurrentBlockHash(int leadingZeros, String[] preProcessDataForLeadingZero){
        ...
        if(timeout && TIMEOUT_TEST){
            logger.info("[Timeout: 10 minutes] in creating current block.");
        }
    }
    ...
    public void setNextBlock(BlockImpl nextBlock){
     ...
     * 
     * @param block the block whose information is to be displayed
     */
    protected void showInfo(BlockImpl block){
        System.out.println("------------------------------------------------------");
        System.out.println("Height:             "+block.height);
        System.out.println("CurrentBlockHash:   "+block.currentBlockHash);
        System.out.println("PreviousBlcokHash:  "+block.previousBlockHash);
        System.out.println("MerkleRootHash:     "+block.merkleRootHash);
        System.out.println("TransactionCount:   "+block.transactionCount);
    ...
    protected void showAll(BlockImpl rootBlock){
        ...
        while(currentBlock != null){
            ...
            System.out.println("CurrentBlockHash:   "+currentBlock.currentBlockHash);
            System.out.println("PreviousBlcokHash:  "+currentBlock.previousBlockHash);
            System.out.println("MerkleRootHash:     "+currentBlock.merkleRootHash);
            System.out.println("TransactionCount:   "+currentBlock.transactionCount);
            System.out.println("Transaction: ");
